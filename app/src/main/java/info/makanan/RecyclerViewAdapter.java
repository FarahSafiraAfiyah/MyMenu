...
public class RecyclerViewAdapter extends  RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
    ...
    public RecyclerViewAdapter(ArrayList<String> gambarMakanan, ArrayList<String> namaMakanan,ArrayList<String>deskripsiMakanan,ArrayList<String>hargamakanan, Context context) {
